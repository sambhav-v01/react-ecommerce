    ...
    <div className="min-h-screen bg-gray-100 py-10 px-4 sm:px-6 lg:px-20">
      <div className="max-w-5xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-8">
        ...
        <p
          ...
          data-aos="fade-up"
        >
          Welcome to <span className="font-semibold text-red-600">Nexte</span>,
        ...
        <div className="space-y-6" data-aos="fade-right">
          ...
          <p className="text-gray-700 text-base">
            At Nexte, our mission is to make innovative technology accessible to
        ...
        <div className="space-y-6" data-aos="fade-left">
          <h2 className="text-2xl font-semibold text-red-600">Why Choose Nexte?</h2>
        ...
        <div className="space-y-6" data-aos="fade-right">
          ...
          <p className="text-gray-700 text-base">
            ...
            Nexte, we’re committed to staying ahead of the curve, offering
        ...
        >
          <h3 className="text-xl font-semibold text-red-600 mb-2">
            Join the Nexte Family
          </h3>
          <p className="text-gray-700 mb-4">
            Whether you’re a tech enthusiast, a professional, or just looking
            for something cool and functional — Nexte has something for everyone.
          </p>
          <Link to={"/products"}>
