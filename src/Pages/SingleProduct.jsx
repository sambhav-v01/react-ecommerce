...
import { Breadcrums } from '../Context/Breadcrums';
...
export const SingleProduct=()=>{
    ...
    const OrignalPrice=Math.round(SingleProduct.price+ (SingleProduct.price*SingleProduct.discount/100))
    return(
        <>
         {
                SingleProduct ? <div className='px-4 pb-4 md:px-0'>
                     ...
                     <div className='max-w-6xl mx-auto md:p-6 grid grid-cols-1 md:grid-cols-2 gap-10'>
                        ...
                        <div className='flex flex-col gap-6'>
                            ...
                            <p className='text-xl text-red-500 font-bold'>${SingleProduct.price} <span className='line-through text-gray-700'>${OrignalPrice}</span> <span className='bg-red-500 text-white px-4 py-2 rounded-full'>{SingleProduct.discount}% discount</span></p>
