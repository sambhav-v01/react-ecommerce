    ...
    <div className='mt-10 max-w-6xl mx-auto mb-5 px-4 md:px-0'>
      {
        cartitem.length > 0 ? <div>
          <div className="flex justify-between" data-aos="fade-down">
            ...
            <h1 className="font-semibold text-xl ">User : {user?.fullName.toUpperCase()}</h1>
          </div>

          <div>
            {cartitem.map((item, index) => {
              return (
                <div key={index} data-aos="fade-up" className='bg-gray-100 p-5 rounded-md flex items-center justify-between mt-3 w-full'>
                  <div className='flex items-center gap-4'>
                    <img src={item.image} alt={item.title} className='w-25 h-25 rounded-md' />
                    <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 md:gap-20">
            {/* left */}
            <div className="bg-gray-100 rounded-md p-7 mt-4 space-y-2" data-aos="fade-right">
              <h1 className="text-gray-800 font-bold text-xl">Delivery Info</h1>
              <div className="flex flex-col space-y-1">
                <label htmlFor="">Full Name</label>
                <input type="text" placeholder="Full Name" className="p-2 rounded-md" value={user?.fullName} />
              </div>
              <div className="flex flex-col space-y-1">
                <label htmlFor="">Address</label>
                <input type="text" placeholder="Your Address" className="p-2 rounded-md" />
              </div>
              <div className="flex w-full gap-5">
                <div className="flex flex-col space-y-1 w-full" >
                  <label htmlFor="">State</label>
                  <input type="text" placeholder="Your State" className="p-2 rounded-md w-full" />
                </div>
                <div className="flex flex-col space-y-1 w-full" >
                  <label htmlFor="">Postcode</label>
                  <input type="text" placeholder="Your Postcode" className="p-2 rounded-md w-full" />
                </div>
              </div>
              <div className="flex w-full gap-5">
                <div className="flex flex-col space-y-1 w-full" >
                  <label htmlFor="">Country</label>
                  <input type="text" placeholder="Your Country" className="p-2 rounded-md w-full" />
                </div>
                <div className="flex flex-col space-y-1 w-full" >
                  <label htmlFor="">Phone No.</label>
                  <input type="text" placeholder="Your PhoneNo. " className="p-2 rounded-md w-full" />
                </div>
              </div>
              <button className="bg-red-500 text-white cursor-pointer px-3 py-1 mt-3 rounded-md">Submit</button>
            ...
            {/* right */}
            <div className='bg-white border border-gray-100 shadow-xl rounded-md p-7 mt-4 space-y-2 h-max' data-aos="fade-left">
              ...
              <div className='flex justify-between items-center'>
                <h1 className='flex gap-1 items-center text-gray-700'><span><GiShoppingBag /></span>Handling Charges</h1>
          ...
          <div className='flex flex-col gap-3 justify-center items-center h-[600px]' data-aos="zoom-in">
