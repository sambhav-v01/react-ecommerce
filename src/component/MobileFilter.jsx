...
export const MobileFilter = ({ openFilter, setOpenFilter, search ,setSearch, category,setcategory,brand,setbrand,  priceRange,setPriceRange, handlebrand, handleCategory}) => {
            ...
            </div>
            {
                openFilter ? <div className='bg-gray-100 p-2 md:hidden'>
                    ...
                    <div className='flex flex-col gap-2'>
                        ...
                        <input type="range" min="0" max="2500" name="" id="" value={priceRange[1]} onChange={(e) => setPriceRange([priceRange[0], Number(e.target.value)])} className='transition-all w-[200px]' />
                    </div>
